...
class AverageCalculatorTest extends Specification {
    ...
    def "test average calculation and credit point sum, expect average #expected_average and cp sum #expected_cp_sum"() {
        ...
        items.add(createGradeItem(grade_1, modified_grade_1, cp_1, modified_cp_1, weight_1))
        items.add(createGradeItem(grade_2, modified_grade_2, cp_2, modified_cp_2, weight_2))
        items.add(createGradeItem(grade_3, modified_grade_3, cp_3, modified_cp_3, weight_3))
