...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        UniversityDao.createTable(db, ifNotExists);
        RuleDao.createTable(db, ifNotExists);
        ActionDao.createTable(db, ifNotExists);
        ActionParamDao.createTable(db, ifNotExists);
        TransformerMappingDao.createTable(db, ifNotExists);
        GradeEntryDao.createTable(db, ifNotExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(UniversityDao.class);
        registerDaoClass(RuleDao.class);
        registerDaoClass(ActionDao.class);
        registerDaoClass(ActionParamDao.class);
        registerDaoClass(TransformerMappingDao.class);
        registerDaoClass(GradeEntryDao.class);
        registerDaoClass(OverviewDao.class);
    }
