 ...
 * Intent example: dh.mygrades.view.activity://goto.fragment/faq/2
 */
public class LinkIntentActivity extends AppCompatActivity implements ReplacableFragment {
     ...
     * @param intentData Uri of the intent (e.g.:dh.mygrades.view.activity://goto.fragment/faq/2)
     */
    private void evaluateIntentFragment(Uri intentData) {
        ...
        if (pathSegments.size() > 0) {
            ...
            // get first path segment e.g. dh.mygrades.view.activity://goto.fragment/faq/2 -> "faq"
