...
public class GradeEntryDao extends AbstractDao<GradeEntry, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Hidden = new Property(15, Boolean.class, "hidden", false, "HIDDEN");
    ...
    public GradeEntry readEntity(Cursor cursor, int offset) {
        GradeEntry entity = new GradeEntry( //
            ...
            cursor.isNull(offset + 15) ? null : cursor.getShort(offset + 15) != 0, // hidden
    ...
    public void readEntity(Cursor cursor, GradeEntry entity, int offset) {
        ...
        entity.setHidden(cursor.isNull(offset + 15) ? null : cursor.getShort(offset + 15) != 0);
